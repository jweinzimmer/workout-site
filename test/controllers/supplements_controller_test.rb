...
class SupplementsControllerTest < ActionController::TestCase
  ...
  test "should create supplement" do
    assert_difference('Supplement.count') do
      post :create, supplement: { brand: @supplement.brand, description: @supplement.description, opinion: @supplement.opinion, price: @supplement.price, serving_size: @supplement.serving_size }
    end
  ...
  test "should update supplement" do
    patch :update, id: @supplement, supplement: { brand: @supplement.brand, description: @supplement.description, opinion: @supplement.opinion, price: @supplement.price, serving_size: @supplement.serving_size }
    assert_redirected_to supplement_path(assigns(:supplement))
  end
